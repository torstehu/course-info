...
3. Go through steps 1 to 3 in the section [Go
   Assignments](https://github.com/uis-dat320-fall17/labs/blob/master/lab1/README.md#go-assignments)
   in Lab 1, but in Step 3 replace the command with `git remote add labs
   git@github.com:uis-dat320-fall17/username-labs.git` (where `username` should be
